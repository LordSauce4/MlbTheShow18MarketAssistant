...
tableHTML = '<table class="sortable" width=100%><thead><tr><th>Name</th><th>Create Buy Order</th><th>Open Buy Orders</th><th>Create Sell Order</th><th>Open Sell Orders</th><th class="sorttable_numeric">Traded/hour</th><th class="sorttable_numeric">Profit%</th></th><th class="sorttable_numeric">Profit%/hour</th></tr></thead><tbody></tbody></table>'
    ...
    $.ajax({
        ...
        $(".marketplace-filter-item-name > a", listingsPageData).each(function () {
            ...
            $.ajax({
                ...
                //        openBuyOrderExists = true
                //    }
                //})
                createBuyOrderCell = $("<td>")
                if (cleanNumberString($(".header-wallet")[0].innerText) > highestBuyOrderNumber || openBuyOrderExists) {
                ...
                //        openSellOrderExists = true
                //    }
                //})
                createSellOrderCell = $("<td>")
                if (cleanNumberString($(".marketplace-card-owned", itemPageData)[1].innerText) > 0 || openSellOrderExists) {
